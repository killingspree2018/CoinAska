...
def generate_equal_volume_distribution_orders(no_of_orders, cash_amount, order_type, price_range_start, price_range_end, price_difference_range_start, price_difference_range_end):
    ...
    prices = generate_random_prices(no_of_orders, price_range_start, price_range_end, price_difference_range_start, price_difference_range_end, buy_order)
    amounts = generate_random_amounts(cash_amount, len(prices))
    orders_list = []
...
def generate_volume_bot_orders(price, amount):
    buy_order = {
        "side": 'BUY',
        "ordType": "LIMIT",
        "ordPrice": price,
        "ordQty": f"{round(amount/price)}"
    }
    sell_order = {
        "side": 'SELL',
        "ordType": "LIMIT",
